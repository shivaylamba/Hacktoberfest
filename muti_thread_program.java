// Name:- Sorathiya Archit
// Enrollment no.:- 181310132054
// Problem is
/*Write an application that creates and starts three threads. Each thread is instantiated
from the same class. It executes a loop with 10 iterations. Each iteration displays string
"HELLO", sleeps for 300 milliseconds. The application waits for all the threads to
