...
namespace BucketSort
{
    internal class BucketSort
    {
        ...
        public void Sort()
        {
            ...
            var totalDigits = NumberOfDigits();

            // bucket array where numbers will be placed
            var pail = new int[10, data.Length + 1];
        ...
        {
            var largest = data[0]; // set largest to first element
            ...
            var digits = (int)(Math.Floor(Math.Log10(largest)) + 1);
        ...
        public void CollectElements(int[,] pails)
        {
            ...
            for (var i = 0; i < 10; i++) // loop over buckets
            {
